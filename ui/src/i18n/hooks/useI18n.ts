  ...
  return {
    ...
    connection: {
      ...
      sidebar: {
        ...
        moreActions: t('connection.sidebar.moreActions'),
        importConnections: t('connection.sidebar.importConnections'),
        exportAllConnections: t('connection.sidebar.exportAllConnections'),
      },
      tooltips: {
        editConnection: t('connection.tooltips.editConnection'),
        copyConnection: t('connection.tooltips.copyConnection'),
        shareConnection: t('connection.tooltips.shareConnection'),
        ...
        moreActions: t('connection.tooltips.moreActions'),
      },
      s3Buckets: {
        title: t('connection.s3Buckets.title'),
        current: t('connection.s3Buckets.current'),
        create: t('connection.s3Buckets.create'),
        createPlaceholder: t('connection.s3Buckets.createPlaceholder'),
        switch: t('connection.s3Buckets.switch'),
        switchTab: t('connection.s3Buckets.switchTab'),
        createTab: t('connection.s3Buckets.createTab'),
        manage: t('connection.s3Buckets.manage'),
        switchPlaceholder: t('connection.s3Buckets.switchPlaceholder'),
        createSuccess: t('connection.s3Buckets.createSuccess'),
        createFailed: t('connection.s3Buckets.createFailed'),
        loadFailed: t('connection.s3Buckets.loadFailed'),
        loadFailedHint: t('connection.s3Buckets.loadFailedHint'),
        switchSuccess: t('connection.s3Buckets.switchSuccess'),
        switchFailed: t('connection.s3Buckets.switchFailed'),
        empty: t('connection.s3Buckets.empty'),
        noBucket: t('connection.s3Buckets.noBucket'),
        refresh: t('connection.s3Buckets.refresh'),
      },
      fields: {
      ...
      share: {
        noConnectionsToExport: t('connection.share.noConnectionsToExport'),
        securityWarningTitle: t('connection.share.securityWarningTitle'),
        securityWarningContent: t('connection.share.securityWarningContent'),
        securityWarningConfirm: t('connection.share.securityWarningConfirm'),
        securityWarningCancel: t('connection.share.securityWarningCancel'),
        modalTitle: t('connection.share.modalTitle'),
        modalDescription: t('connection.share.modalDescription'),
        copyButton: t('connection.share.copyButton'),
        downloadButton: t('connection.share.downloadButton'),
        closeButton: t('connection.share.closeButton'),
        copySuccess: t('connection.share.copySuccess'),
        copyFailed: t('connection.share.copyFailed'),
        downloadSuccess: t('connection.share.downloadSuccess'),
        downloadFailed: t('connection.share.downloadFailed'),
      },
      import: {
        modalTitle: t('connection.import.modalTitle'),
        modalDescription: t('connection.import.modalDescription'),
        pastePlaceholder: t('connection.import.pastePlaceholder'),
        selectFileButton: t('connection.import.selectFileButton'),
        previewTitle: t('connection.import.previewTitle'),
        confirmButton: t('connection.import.confirmButton'),
        cancelButton: t('connection.import.cancelButton'),
        parseFailed: t('connection.import.parseFailed'),
        importSuccessSingle: t('connection.import.importSuccessSingle'),
        importSuccessMultiple: t('connection.import.importSuccessMultiple'),
        importFailed: t('connection.import.importFailed'),
        nameSuffix: t('connection.import.nameSuffix'),
      },
    },
    // 文件管理器相关文本
    fileManager: {
      ...
      actions: {
        ...
        editWithLocalEditor: t('fileManager.actions.editWithLocalEditor'),
        openWith: t('fileManager.actions.openWith'),
        chooseEditor: t('fileManager.actions.chooseEditor'),
      ...
      dialogs: {
        ...
        selectFilesToUpload: t('fileManager.dialogs.selectFilesToUpload'),
      ...
      messages: {
        ...
        copyPartial: t('fileManager.messages.copyPartial'),
        copySameConnectionIgnored: t('fileManager.messages.copySameConnectionIgnored'),
        dragFileToConnection: t('fileManager.messages.dragFileToConnection'),
        itemsCount: t('fileManager.messages.itemsCount'),
        ...
        uploadCancelled: t('fileManager.messages.uploadCancelled'),
        uploadCancelling: t('fileManager.messages.uploadCancelling'),
        uploadCancel: t('fileManager.messages.uploadCancel'),
        uploadingDirectory: t('fileManager.messages.uploadingDirectory'),
        uploadingFile: t('fileManager.messages.uploadingFile'),
        ...
        editorEditingSingle: t('fileManager.messages.editorEditingSingle'),
        editorEditingMultiple: t('fileManager.messages.editorEditingMultiple'),
        editorSynced: t('fileManager.messages.editorSynced'),
        editorNoChanges: t('fileManager.messages.editorNoChanges'),
        editorFailed: t('fileManager.messages.editorFailed'),
        editorAbandoned: t('fileManager.messages.editorAbandoned'),
        editorAbandonTitle: t('fileManager.messages.editorAbandonTitle'),
        editorAbandonDescription: t('fileManager.messages.editorAbandonDescription'),
        editorKeepEditing: t('fileManager.messages.editorKeepEditing'),
        editorConflictTitle: t('fileManager.messages.editorConflictTitle'),
        editorConflictDescription: t('fileManager.messages.editorConflictDescription'),
        editorSaveAsPlaceholder: t('fileManager.messages.editorSaveAsPlaceholder'),
        editorReturn: t('fileManager.messages.editorReturn'),
        editorSaveAs: t('fileManager.messages.editorSaveAs'),
        editorOverwrite: t('fileManager.messages.editorOverwrite'),
        editorRecoveredTitle: t('fileManager.messages.editorRecoveredTitle'),
        editorRecoveredDescription: t('fileManager.messages.editorRecoveredDescription'),
        detectingEditors: t('fileManager.messages.detectingEditors'),
        noEditorsDetected: t('fileManager.messages.noEditorsDetected'),
      },
      table: {
        ...
        editButton: t('fileManager.table.editButton'),
        finishEditButton: t('fileManager.table.finishEditButton'),
        reopenEditButton: t('fileManager.table.reopenEditButton'),
        abandonEditButton: t('fileManager.table.abandonEditButton'),
      ...
      toolbar: {
        ...
        batchUpload: t('fileManager.toolbar.batchUpload'),
        uploadDirectory: t('fileManager.toolbar.uploadDirectory'),
      },
      batchUpload: {
        conflictTitle: t('fileManager.batchUpload.conflictTitle'),
        conflictDescription: t('fileManager.batchUpload.conflictDescription'),
        conflictCount: t('fileManager.batchUpload.conflictCount'),
        defaultAction: t('fileManager.batchUpload.defaultAction'),
        file: t('fileManager.batchUpload.file'),
        remotePath: t('fileManager.batchUpload.remotePath'),
        action: t('fileManager.batchUpload.action'),
        skip: t('fileManager.batchUpload.skip'),
        overwrite: t('fileManager.batchUpload.overwrite'),
        fileConflict: t('fileManager.batchUpload.fileConflict'),
        directoryConflict: t('fileManager.batchUpload.directoryConflict'),
        directoryConflictHint: t('fileManager.batchUpload.directoryConflictHint'),
        startUpload: t('fileManager.batchUpload.startUpload'),
        checkingConflicts: t('fileManager.batchUpload.checkingConflicts'),
        progress: t('fileManager.batchUpload.progress'),
        completed: t('fileManager.batchUpload.completed'),
        completedWithIssues: t('fileManager.batchUpload.completedWithIssues'),
      },
      pagination: {
    ...
    settings: {
      ...
      diagnosticsHint: t('settings.diagnosticsHint'),
      ...
      localEditor: t('settings.localEditor'),
      editorCustom: t('settings.editorCustom'),
      editorSetDefault: t('settings.editorSetDefault'),
      editorRemove: t('settings.editorRemove'),
      editorAdd: t('settings.editorAdd'),
      editorAddFailed: t('settings.editorAddFailed'),
      editorDuplicate: t('settings.editorDuplicate'),
      editorNoCandidates: t('settings.editorNoCandidates'),
      editorOtherApplications: t('settings.editorOtherApplications'),
      editorChooseFromComputer: t('settings.editorChooseFromComputer'),
      editorNoOtherApplications: t('settings.editorNoOtherApplications'),
      editorApplications: t('settings.editorApplications'),
      editorSelect: t('settings.editorSelect'),
      editorSaveFailed: t('settings.editorSaveFailed'),
    },
    // 演示页面相关文本
    demo: {
      title: t('demo.title'),
