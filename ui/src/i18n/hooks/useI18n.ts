...
export const useAppI18n = () => {
  ...
  return {
    ...
    settings: {
      ...
      editorAutoDetect: t('settings.editorAutoDetect'),
      editorBrowse: t('settings.editorBrowse'),
      editorSave: t('settings.editorSave'),
      editorSelect: t('settings.editorSelect'),
      editorHint: t('settings.editorHint'),
      editorSaved: t('settings.editorSaved'),
